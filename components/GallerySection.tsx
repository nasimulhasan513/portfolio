...
import { X, ChevronLeft, ChevronRight, Globe, Clapperboard } from "lucide-react";

const countries = ["India", "Maldives", "Sri Lanka"];
          ...
          <div className="mt-6 flex flex-wrap items-center gap-x-4 gap-y-3">
            ...
            <ul className="flex flex-wrap gap-2">
              {countries.map((c) => (
                <li
                  key={c}
                  className="rounded-full border border-slate-200 bg-white px-3 py-1 text-sm font-medium text-ink-soft"
                >
                  {c}
                </li>
              ))}
